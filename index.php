...
<body>
    ...
    <symbol id="telefone" viewBox="0 0 16 16">
    ...
    <header>
    <div class="px-3 py-2  text-white" id="color-default">
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
             <img src="./images/logo-caseirinho.png" >
          </a>
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="index.php?pagina=home.php" class="nav-link text-white">
                <svg class="icon-color d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#home"/></svg>
                Home
              </a>
            </li>
            <li>
    ...
    <img id="ajust-img" src ="./images/calda-derretendo.png">
  </header>
   <main>
   <?php 
    ...
    <div class="container">
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            ...
            <span id="footer-font">&copy; 2021 - Caseirinho Doces Caseiros Ltda.</span>
            </div>
